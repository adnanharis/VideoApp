...
public class FingerPaint extends Activity
        implements ColorPickerDialog.OnColorChangedListener, OnPreparedListener, OnCompletionListener{    
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addContentView(new MyView(this), new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
        mPaint = new Paint();
